...
<%
sql="select * from jifen where usersid="&Request.Cookies("userqt")("id")&" "
...
%>
		<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#D7A743">
		  <tr>
			<td align="center" class="color_white">兑换日期</td>
			<td align="center" class="color_white">兑换商品</td>
			<td align="center" class="color_white">商品价值</td>
			<td align="center" class="color_white">兑换数量</td>
			<td align="center" class="color_white">合计价值</td>
			<td align="center" class="color_white">所需积分</td>
			<td align="center" class="color_white">剩余积分</td>
		  </tr>
<%Do while not rs.Eof%>
		  <tr>
			...
			<td align="right" bgcolor="#FFFFFF" class="color_hs"><%=rs("score2")%></td>
		  </tr>
<%
i=i+1
rs.MoveNext
